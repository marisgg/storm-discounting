...
ToJuliaSettings::ToJuliaSettings() : ModuleSettings(moduleName) {
    this->addOption(storm::settings::OptionBuilder(moduleName, discountOption, false, "Sets the discount factor considered for the Julia export")
                        .addArgument(storm::settings::ArgumentBuilder::createDoubleArgument("discount", "the discount factor")
                                         .setDefaultValueDouble(0.95)
